const supportLinks = ['Contact', 'FAQs', 'Pricing Plan', 'Sitemap']
const quickLinks = ['Job', 'Courses', 'Paid Training', 'Blog']
const categoryLinks = ['Graphics', 'Programming', 'eCommerce', 'Freelancing']

const Footer = () => {
    return (
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl max-sm:px-8 p-4 py-6 lg:py-8">

                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 md:grid-cols-4 md:gap-16">
                    ...
                    <div className="mb-6 md:mb-0">
                        ...
                        <div className="font-medium text-gray-500 dark:text-gray-400">
                            <p className="mb-4">4517 Washington Ave. Manchester Kentucky 39495</p>
                            <p className="mb-4">Phone: (405) 555-0128</p>
                            <p className="mb-4">Mail: info@learningonline.com</p>
                        </div>
                    </div>
                        ...
                        <ul className="font-medium text-gray-500 dark:text-gray-400">
                            {supportLinks.map((link, index) => (
                                <li className="mb-4" key={index}>
                                    <a href="https://flowbite.com/" className="hover:underline">{link}</a>
                                </li>
                            ))}                            
                        </ul>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between">
                    <span className="text-sm text-gray-500 text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
